...
def main():
    ...
    # Заголовок
    st.title("🛡️ SystemWatch Pro")
    st.markdown("**Моя програма для моніторингу комп'ютера (дипломна робота)**")
...
def show_dashboard():
    """Основна сторінка з показниками системи"""
